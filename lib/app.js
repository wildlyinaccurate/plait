...
function start(component) {
  ...
  var initialTree = renderComponent(initialState);
  var rootNode = vdom.createRoot(initialTree);
  var updateTree = vdom.createRenderCycle(rootNode, initialTree, renderComponent, raf);
