...
// Render a Plait app node to a DOM node
function render(appNode, node) {
  var staticNode = node.querySelector('[' + ROOT_IDENTIFIER + ']');

  if (staticNode) {
    // Bootstrap to the statically-rendered node
  } else {
